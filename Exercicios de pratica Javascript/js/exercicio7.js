function listarCasos() {
    ...
    let valorQuadrado, doisPrimeirosAlgarismos, doisUltimosAlgarismos
    for (let numero = 32; numero < 100; numero++) {
        valorQuadrado = numero * numero;
        doisPrimeirosAlgarismos = Math.floor(valorQuadrado%100)
        valorQuadrado /= 100
        doisUltimosAlgarismos = Math.floor(valorQuadrado%100)
        if (doisPrimeirosAlgarismos + doisUltimosAlgarismos == numero) {
